...
- Status: **Draft / proposed**. 本文是目标契约，不是实现或验收完成声明。
- Date: 2026-09-25
...
本文中的 MUST / MUST NOT / SHOULD 分别表示必须 / 禁止 / 建议。除 §2 代码基线外，类型、接口、字段、默认值和 UI 均为提案。本文只拥有**诊断投影**，不重新定义资源准入、调度、删除许可或 Change 完成条件。
